...
\begin{figure}
    ...
    \end{subfigure}
	\caption[Breakout parameter $\C$ at height $z=0\,H$]{Breakout parameter $\C$ versus SMBH mass and radius in the accretion disk for SNe detonating at the disk midplane.
